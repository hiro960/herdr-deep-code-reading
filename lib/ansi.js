...
const screen = {
  enterAlt: CSI + "?1049h",
  // Ask the terminal to wrap a paste in markers. Without them a pasted newline is the
  // byte the Enter key sends, and a commit message pasted in three lines is one line
  // committed and two lines of keystrokes — see lib/input.
