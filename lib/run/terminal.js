...
function enterFullScreen() {
  process.stdout.write(
    screen.enterAlt + screen.hideCursor + screen.clear + screen.enableBracketedPaste
  );
...
function leaveFullScreen() {
  ...
  process.stdout.write(screen.disableBracketedPaste + screen.showCursor + screen.leaveAlt);
}
